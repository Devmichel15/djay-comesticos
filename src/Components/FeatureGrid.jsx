...
const FeatureGrid = () => {
  ...
  const featuredProducts = produtosData.map((cat, catIdx) => ({
    ...cat.produtos[0],
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Blob animation (scale and rotation - compatible with free GSAP)
      // Note: MorphSVG requires paid GSAP Club membership
      gsap.to(".blob-svg", {
        scale: 1.05,
        rotation: 5,
        duration: 4,
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20">
        <div ref={titleRef} className="flex flex-col md:flex-row justify-between items-end mb-20 px-2">
          <div className="overflow-hidden">
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <span className="text-gold/50 text-xs font-mono uppercase tracking-widest">Premium Collection</span>
            </div>
          </div>
        </div>
          ...
          {featuredProducts.map((product, index) => (
            ...
            >
              ...
              <div 
                ...
                onClick={() => navigate(`/produto/${product.categoryIndex}-0`)}
              >
                {/* Animated Blob */}
                <svg
                  viewBox="0 0 200 200"
                ...
                >
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="35%" stopColor="#E6C97A" stopOpacity="0.8" />
                      <stop offset="65%" stopColor="#D4A017" stopOpacity="0.9" />
                      <stop offset="100%" stopColor="#F1F1F1" stopOpacity="0.7" />
                    </linearGradient>
              ...
              >
                ...
                <span className="relative z-10 group-hover/btn:text-gold transition-colors">Comprar já</span>
              </button>
            </div>
          ))}
        </div>
